...
<body>
    <div class="container">
        <h2>✍️ Tulis Artikel (Versi AMAN)</h2>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="file-input-wrapper">
                    ...
                    <div class="file-input-button">Pilih file (JPG, PNG, GIF, PDF - Maks 2MB)</div>
                </div>
            </div>
        ...
        <p class="info-safe">
            ✅ Versi ini memblokir file berbahaya dan hanya mengizinkan gambar/PDF dengan validasi yang ketat.
        </p>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fileInput.addEventListener('change', function() {
                if (fileInput.files.length > 0) {
                    ...
                    fileButton.textContent = 'Pilih file (JPG, PNG, GIF, PDF - Maks 2MB)';
                }
            });
